...
class GroupsDevCleaner extends SeederBase
{
    public $db_link = 'default';
    public $seeder_name = 'A/U Groups Dev Cleaner';
    ...
    public function up()
    {
        ...
        $result = \SQL2::queryStatic(null, '/Numbers/Audiences/Audiences/SQL/GroupsDeleteByCodePrefix.object.sql', null, [
            'tenant_id' => $tenant_id,
            'code_prefix' => 'GRP_SDR_%',
        ]);
        if (!$result['success']) {
