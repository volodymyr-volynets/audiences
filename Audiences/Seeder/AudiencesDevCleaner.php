...
class AudiencesDevCleaner extends SeederBase
{
    public $db_link = 'default';
    public $seeder_name = 'A/U Audiences Dev Cleaner';
    ...
    public function up()
    {
        ...
        $result = \SQL2::queryStatic(null, '/Numbers/Audiences/Audiences/SQL/AudiencesDeleteByCodePrefix.object.sql', null, [
            'tenant_id' => $tenant_id,
            'code_prefix' => 'AUD_SDR_%',
        ]);
        if (!$result['success']) {
